...
`metafit.report`, not written by hand**: term importance is ranked by standardised weight,
major terms are the leading ones carrying 80% of the weight mass, and each one gets a
sentence built from its own row of the table.
