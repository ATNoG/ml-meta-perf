...
0.672, is not a failure of the method — it reflects a documented property of classifier
...
| Reported R² | ~0.9 (opaque), >0.7 (GP) | 0.672 in-sample, 0.652 LOO-dataset |
...
- **Interaction structure.** The gap between E3 (0.672) and the rank-1 oracle (0.783)
