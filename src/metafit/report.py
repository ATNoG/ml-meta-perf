...
Feature-level guidance is not re-derived here. It comes from `metafit.practices`, which
...
def term_sentences(importance: pl.DataFrame, limit: int | None = None) -> list[str]:
    ...
    direction depends on the other terms it appears in and is `metafit.practices`' job.
    """
...
def render(
    ...
    *,
    ...
    parts.append(
        "Generated by `metafit.report.render`. Every number, table and sentence below is "
